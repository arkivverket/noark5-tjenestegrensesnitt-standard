...
```Python
{
    "_links": [
        ...
        },
        {
            ...
            "rel": "http://rel.arkivverket.no/noark5/v4/api/sakarkiv/"
        }
    ]
}
```
...
(http://rel.arkivverket.no/noark5/v4/api/arkivstruktur/) og sakarkiv
(http://rel.arkivverket.no/noark5/v4/api/sakarkiv/).
...
<Links
    ...
    <Links>
        <link>
            <rel>http://rel.arkivverket.no/noark5/v4/api/arkivstruktur/</rel>
        ...
        <link>
            <rel>http://rel.arkivverket.no/noark5/v4/api/sakarkiv/</rel>
...
| ---------------------------------------------- | ------------------------------------------------------ |
| http://rel.arkivverket.no/noark5/v4/api/arkivstruktur/ | Arkivkjerne støtter konformitetsnivå 1 arkivstruktur   |
| http://rel.arkivverket.no/noark5/v4/api/sakarkiv/      | Arkivkjerne støtter konformitetsnivå for sakarkiv (2a) |
    ...
    "_links": [
        {
            ...
            "rel": "http://rel.arkivverket.no/noark5/v4/api/arkivstruktur/arkiv/",
            "templated": true
        },
        {
            "href": "http://localhost:49708/api/arkivstruktur/ny-arkivskaper",
            "rel": "http://rel.arkivverket.no/noark5/v4/api/arkivstruktur/ny-arkivskaper/",
        },
```
...
rel="http://rel.arkivverket.no/noark5/v4/api/arkivstruktur/ny-mappe/"
    ...
    "_links": [
        {
            ...
            "rel": "http://rel.arkivverket.no/noark5/v4/api/administrasjon/dokumentmedium/",
            "templated": true
        },
        {
            "href": "http://localhost:49708/api/kodelister/Mapetype{?$filter&$orderby&$top&$skip}",
            "rel": "http://rel.arkivverket.no/noark5/v4/api/administrasjon/mappetype/",
            "templated": true
        }
    ]
}
...
```Python
{
    ...
    "_links": [
        ...
        },
        {
            ...
            "rel": "http://rel.arkivverket.no/noark5/v4/api/arkivstruktur/avslutt-mappe/",
        },
        {
            "href": "http://localhost:49708/api/arkivstruktur/Mappe/515c45b5-e903-4320-a085-2a98813878ba/utvid-til-saksmappe",
            "rel": "http://rel.arkivverket.no/noark5/v4/api/sakarkiv/utvid-til-saksmappe/",
        },
```
...
(http://rel.arkivverket.no/noark5/v4/api/arkivstruktur/ny-mappe/)
...
```Python
{
    ...
    "_links": [
        ...
        {
            "href": "http://localhost:49708/api/arkivstruktur/Dokumentobjekt/a895c8ed-c15a-43f6-86de-86a626433785",
            "rel": "http://rel.arkivverket.no/noark5/v4/api/arkivstruktur/dokumentobjekt/",
        },
        {
