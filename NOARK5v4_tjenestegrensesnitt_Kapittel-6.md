...
![](./media/image1.emf){width="2.21875in" height="1.6458333333333333in"}
...
GET
[[http://localhost:49708/api]{.underline}](http://localhost:49708/api)
...
([[http://rel.kxml.no/noark5/v4/api/sakarkiv]{.underline}](http://rel.kxml.no/noark5/v4/api/sakarkiv)).
...
![](./media/image3.png){width="4.875in" height="2.7395833333333335in"}
...
**Relasjonsnøkler på rotnivå**
  ...
  -------------------------------------------------------------- --------------------------------------------------------
  [http://rel.kxml.no/noark5/v4/api/arkivstruktur]{.underline}   Arkivkjerne støtter konformitetsnivå 1 arkivstruktur
  [http://rel.kxml.no/noark5/v4/api/sakarkiv]{.underline}        Arkivkjerne støtter konformitetsnivå for sakarkiv (2a)
...
([[http://docs.oasis-open.org/odata/odata/v4.0/os/part2-url-conventions/odata-v4.0-os-part2-url-conventions.html\#\_Toc372793790]{.underline}](http://docs.oasis-open.org/odata/odata/v4.0/os/part2-url-conventions/odata-v4.0-os-part2-url-conventions.html#_Toc372793790)
...
![](./media/image4.png){width="6.3in" height="1.25625in"}
...
**[Større enn eller lik]{.smallcaps}**
...
**[Mindre enn eller lik]{.smallcaps}**
...
**[De to første mappene med test i tittelen]{.smallcaps}**

/api/arkivstruktur/mappe/?\$top=2&\$filter=substringof(\'test\',tittel)

**[Mapper med graderingskode B]{.smallcaps}**

/api/arkivstruktur/mappe/?\$filter=gradering/graderingskode/kode eq
\'B\'

**[Mapper med merknader som har merknadstype B]{.smallcaps}**
  ...
  [[../arkivdel/1235/mappe?\$top=2&\$filter=contains('testmappe', tittel) eq true](http://n5test.kxml.no/api/arkivstruktur/Arkivdel/1235/mappe?$top=2&$filter=tittel%20eq%20%E2%80%98testmappe%E2%80%99) \$orderby=oppdatertDato desc]{.underline}   De to første mapper hvor testmappe er en del av tittel sortert synkende på oppdatertDato   basis
...
rel=»[<http://rel.kxml.no/noark5/v4/api/arkivstruktur/ny-mappe/>»]{.underline}
om bruker har lov til å opprette mapper på denne arkivdelen. Den
aktuelle ressurslenke kan være
[[http://n5test.kxml.no/api/arkivstruktur/Arkivdel/12345/ny-mappe]{.underline}](http://n5test.kxml.no/api/arkivstruktur/Arkivdel/12345/ny-mappe).
...
![](./media/image5.png){width="6.3in" height="2.4618055555555554in"}
...
![](./media/image6.png){width="3.0625in" height="1.5104166666666667in"}
...
![](./media/image7.png){width="6.3in" height="3.1458333333333335in"}
...
([<http://rel.kxml.no/noark5/v4/api/arkivstruktur/ny-mappe/>)]{.underline}
...
lagret objekt. ETag
([http://en.wikipedia.org/wiki/HTTP\_ETag]{.underline} ) skal benyttes
for å støtte «optimistic concurrency control». Om det oppstår konflikt
så kan resultatkode 409 benyttes. Da må klient hente opp ny versjon fra
arkivkjerne og gjøre fletting av data mellom server og klient. For å
redusere risikoen for konflikt bør derfor klienten alltid hente en fersk
utgave av objektet med en GET-forespørsel og deretter oppdatere
opbjektet med en PUT-forespørsel.
...
![](./media/image9.png){width="6.3in" height="3.901388888888889in"}
...
**PUT
[[http://n5test.kxml.no/api/sakarkiv/Saksmappe/1/utvid-til-saksmappe]{.underline}](http://n5test.kxml.no/api/sakarkiv/Saksmappe/1/utvid-til-saksmappe)**
...
Ved sletting av referanser i en liste skal \$id-parameteren benyttes.
...
![](./media/image10.png){width="4.822916666666667in" height="6.40625in"}
...
-   [http://skjema.kxml.no/arkivverket/noark5/v4.0/]{.underline}

Datoformat skal være angitt ihht
[[http://www.w3.org/TR/NOTE-datetime]{.underline}](http://www.w3.org/TR/NOTE-datetime)
...
GET
[[http://localhost:49708/api/arkivstruktur/Dokumentobjekt/a895c8ed-c15a-43f6-86de-86a626433785]{.underline}](http://localhost:49708/api/arkivstruktur/Dokumentobjekt/a895c8ed-c15a-43f6-86de-86a626433785)

![](./media/image11.png){width="6.3in" height="2.4145833333333333in"}

GET
[[http://localhost:49708/api/arkivstruktur/Dokumentobjekt/a895c8ed-c15a-43f6-86de-86a626433785/referanseFil]{.underline}](http://localhost:49708/api/arkivstruktur/Dokumentobjekt/a895c8ed-c15a-43f6-86de-86a626433785/referanseFil)
...
[[https://developers.google.com/drive/v3/web/resumable-upload]{.underline}](https://developers.google.com/drive/v3/web/resumable-upload).
